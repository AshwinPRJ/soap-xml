...
CREATE TABLE `tblproperty_details_api` (
  ...
  `PropertyNo` varchar(345)  DEFAULT NULL,
  `BlockName` varchar(345)  DEFAULT NULL,
  `StreetName` varchar(345)   DEFAULT NULL,
  ...
  `PropertyAddress` varchar(445)   DEFAULT NULL,
  `OwnerAddress` varchar(345)   DEFAULT NULL,
  `OccupierName` varchar(345)   DEFAULT NULL,
  `OwnerFirstName` varchar(345)   DEFAULT NULL,
  `OwnerMiddleName` varchar(345)   DEFAULT NULL,
  `OwnerLastName` varchar(345)   DEFAULT NULL,
  `OwnerFirstNameEng` varchar(345)   DEFAULT NULL,
  `OwnerMiddleNameEng` varchar(345)   DEFAULT NULL,
  `OwnerLastNameEng` varchar(345)   DEFAULT NULL,
  ...
  `RRNo` varchar(345)   DEFAULT NULL,
  `PropertyStatus` varchar(345)  DEFAULT NULL,
...
CREATE TABLE `tblsas_floor_details_api` (
  ...
  PRIMARY KEY (`SNo`),
  FOREIGN KEY SASID (SASID) REFERENCES tblsas_master_details_api(SASID)
