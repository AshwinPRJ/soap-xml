...
const headers = {
  ...
  'soapAction': 'http://tempuri.org/GetDemandAndCollectionDetails',
};
const xml = `<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
              <soap:Body>
                <GetDemandAndCollectionDetails xmlns="http://tempuri.org/">
                  <CityId>101</CityId>
                  <WardId>1</WardId>
                </GetDemandAndCollectionDetails>
              </soap:Body>
            </soap:Envelope>`;
(async () => {
  ...
  fs.writeFile('./output/getDemandAndCollectionDetails.txt', output, (err) => {  
    if (err) throw err;
